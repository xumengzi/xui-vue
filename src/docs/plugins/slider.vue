<template>
  <div class="xui-vue markdown-section">
    <div class="main">
      ...
      <ul>
        <li>
          <code>options</code>幻灯片的数据源, 格式为数组
          <strong>必传</strong>
        </li>
        <li>
          <code>animation</code>表示幻灯片更换的时间,动画等
        </li>
        <li>
          <code>duration</code>表示每一张幻灯片显示的时间
        </li>
        <li>
          <code>styles</code>自定义样式, 将会被添加到幻灯片组件上
        </li>
        <li>
          <code>change</code>幻灯片切换的回调,返回当前索引以及幻灯片组件元素
        </li>
        <li>
          没有你想要的功能? 快联系我:
