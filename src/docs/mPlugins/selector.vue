<template>
    <div class="xui-vue markdown-section">
        <div class="main">
            ...
            <ul>
                <li><code>selectorData</code>下拉框列表数据源, 类型为数组<strong>必传</strong>, 可以设置禁止选中</li>
                <li><code>selectorValue</code>默认选中的一项</li>
                <li><code>extralClass</code>自定义下拉框类名</li>
                <li><code>sendChooseData</code>点击确定后的回调, 返回当前选择的<code>label</code>和<code>value</code>, 是一个对象</li>
...
export default {
  ...
  data () {
    return {
      ...
      selectorValue: '',
      params: 
`import { FcSelector } from 'fcbox-m-ui';
Vue.use(FcSelector);
